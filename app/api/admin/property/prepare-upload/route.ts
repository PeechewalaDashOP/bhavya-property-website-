...
// Admin-side signed-upload issuer. Identical mechanics to the dealer route
// (app/api/dealer/property/prepare-upload) — the only difference is the auth
// gate: an admin bearer token instead of a dealer session. Kept as its own
// route so the admin panel never depends on a dealer login existing.

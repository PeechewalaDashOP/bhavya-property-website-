      ...
      <div style={{ maxWidth: 520, margin: "0 auto", padding: "0 14px" }}>
              ...
              <div className={styles.section}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: 14, fontWeight: 700, color: "#1568c2", background: "rgba(21,104,194,0.04)",
                    cursor: "pointer",
                  }}
                >
                  + Add Room Type
        ...
        {step === 3 && !uploading && (
          <>
                  ...
                  {videoNames.map((name, i) => (
                    <div
                      ...
                      style={{
                        ...
                        background: "rgba(21,104,194,0.04)",
                        border: "1px solid rgba(21,104,194,0.18)",
            ...
            {submitErr && (
              <div style={{ background: "rgba(220,53,69,0.07)", border: "1px solid rgba(220,53,69,0.25)", borderRadius: 10, padding: "12px 16px", marginBottom: 10, color: "var(--red)", fontSize: 14, lineHeight: 1.4 }}>
                {submitErr}
              </div>
            )}
        ...
        {uploading && (
          <div className={styles.section} style={{ marginTop: 8 }}>
            <div className={styles.uploadOverlay}>
              ...
              <div style={{ fontSize: 16, fontWeight: 800, color: "#1568c2" }}>
